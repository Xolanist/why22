...
This crate isn't strictly part of why but allows the generation and release of a new Why Genesis in an automated fashion. The process is the following:

* Prepare a multisig output and kernel to use as coinbase. In the case of Why mainnet, this is done and owned by the council treasurers. This can be down a few days prior.
