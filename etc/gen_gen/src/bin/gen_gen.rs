...
use why_miner_plugin as plugin;
use why_store as store;
use grin_util::{self as util, ToHex};
use why_wallet as wallet;

use why_core::core::hash::Hashed;
use why_core::core::verifier_cache::LruVerifierCache;
use why_keychain::{BlindingFactor, ExtKeychain, Keychain};
...
fn main() {
...

	{
		...
		let tmp_chain = setup_chain(".why.tmp", core::pow::mine_genesis_block().unwrap());
