...
When you are starting to contribute to why, we really would appreciate if you come by the gitter chat channels.

In case of problems with trying out why, before starting to contribute, there's the [whycoin#support](https://keybase.io/team/whycoin) on Keybase. Write there about what you've done, what you want to do, and maybe paste logs through a text paste webservice.

* Please [join the whycoin#general  on Keybase](https://keybase.io/team/whycoin) to get a feeling for the community.
* And see the developers chat channel [whycoin#dev  on Keybase](https://keybase.io/team/whycoin) if you have questions about source code files.
  If you explain what you're looking at and what you want to do, we'll try to help you along the way.
* See `docs/*.md` and the folder structure explanations, [the wiki](https://github.com/mimblewimble/docs/wiki) and the official [Why documentation](https://docs.why.mw/).
* Further information and discussions are in the [Forum](https://forum.why.mw), the [website](https://why.mw), the [mailing list](https://lists.launchpad.net/mimblewimble/) and news channels like the [Reddit/whycoin](https://www.reddit.com/r/whycoin/) and a (mostly unfiltered!) Twitter bot that collects headlines, mailing list posts, and reddit posts related to Mimblewimble/Why: [@whymw](https://twitter.com/whymw)
...
The most important thing you can do alongside - or even before - changing code, is adding tests for how why should and should not work. See the various `tests` folders and derive test that are already there in why.
...
For example: `fix: a panick on xxx when why exiting`. Please don't worry if you can't find a suitable prefix, this's just optional, not mandatory.
...
**Note**: To work with why you must use `rustup`. Linux package managers typically carry a too old rust version.
...
3. Please don't ~~`cargo +nightly fmt`~~ because all why developers are using stable rustfmt. Also please don't rustfmt files that your code changes does not touch to avoid causing merge conflicts.

## Thanks for any contribution

Even one word correction are welcome! Our objective is to encourage you to get interested in Why and contribute in any way possible. Thanks for any help!
