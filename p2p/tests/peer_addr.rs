...
fn test_peer_addr_hashing() {
	...
	let socket_addr1 = SocketAddr::new(IpAddr::V4(Ipv4Addr::new(192, 168, 0, 1)), 9080);
	...
	let socket_addr2 = SocketAddr::new(IpAddr::V4(Ipv4Addr::new(192, 168, 0, 1)), 9081);
	...
	assert_eq!(peer_addr1.0.port(), 9080);
	assert_eq!(peer_addr2.0.port(), 9081);
}
