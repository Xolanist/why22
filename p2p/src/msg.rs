...
/// Why's user agent with current version
pub const USER_AGENT: &str = concat!("MW/Why ", env!("CARGO_PKG_VERSION"));

/// Magic numbers expected in the header of every message
const OTHER_MAGIC: [u8; 2] = [80, 60];
const TESTNET_MAGIC: [u8; 2] = [90, 66];
const MAINNET_MAGIC: [u8; 2] = [99, 67];
