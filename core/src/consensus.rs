...
/// A why is divisible to 10^9, following the SI prefixes
pub const GRIN_BASE: u64 = 1_000_000_000;
/// Milliwhy, a thousand of a why
pub const MILLI_GRIN: u64 = GRIN_BASE / 1_000;
/// Microwhy, a thousand of a milliwhy
pub const MICRO_GRIN: u64 = MILLI_GRIN / 1_000;
/// Nanowhy, smallest unit, takes a billion to make a why
...
/// The block subsidy amount, one why per second on average
