...
mod tests {
	...
	fn tests<'a>() -> Vec<Test<'a>> {
		vec![
            ...
            Test {
                entropy: "90809080908090809080908090809080",
            ...
            Test {
                entropy: "908090809080908090809080908090809080908090809080",
            ...
            Test {
                entropy: "9080908090809080908090809080908090809080908090809080908090809080",
