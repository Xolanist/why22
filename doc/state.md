...
The full state of a Why chain consists of all the following data:
...
With a full Why state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in Why is simple: a plain
