...
#### WARNING: This document is still in progress and has not yet been reviewed by any of the core Why developers.
...
|------|---------|-----------------|-----------------------------------------------------------------------------------|
| 2    | Magic   | uint8[2]        | Magic number used to identify Why packets. Always hard-coded as {0x1E, 0xC5}.    |
...
| ?    | UserAgent       | VAR_STR          | Name and version of the software. Example: "MW/Why 0.1.2"                                 |
...
|------|-----------------|-----------|-----------------------------------------------------------------------------------------------------|
| 8    | TotalDifficulty | uint64    | Total difficulty accumulated by the sender. Used to check whether sync may be needed.               |
| 8    | Height          | uint64    | Total block height accumulated by the sender. See: https://github.com/mimblewimble/why/issues/1779 |
