...
本文说明在 Why 部署目前的 Stratum RPC 协议。
...
矿工发起消息。矿工用用户名、密码和代理（通常由矿工程序设置）登录 Why Stratum 服务器。
...
挖矿部署请参阅：[mimblewimble/why-miner](https://github.com/mimblewimble/why-miner/blob/master/src/bin/client.rs)
