...
A Why transaction consists of the following -
...
Why does not permit duplicate commitments to exist in the Output set at the same time.
...
This is not necessarily recommended but Why must handle this situation in a way that does not break consensus across the network.
...
Why does not allow duplicate commitments to exist in the Output set simultaneously.
