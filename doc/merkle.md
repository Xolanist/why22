...
A design goal of Why is that all structures be as easy to implement and
...
are simple to specify (no scripts) and Why is written in a language with
...
Why itself does not need proof-of-spentness but it is a good thing to support
