# Introduction to Mimblewimble and Why
...
Why is an open source software project that implements a Mimblewimble
blockchain and fills the gaps required for a full blockchain and
cryptocurrency deployment.

The main goal and characteristics of the Why project are:
...
A detailed post on the step-by-step of how Why transactions work (with graphics) can be found [in this Medium post](https://medium.com/@brandonarvanaghi/why-transactions-explained-step-by-step-fdceb905a853).
...
to explain the technical buildup of Mimblewimble and how it's applied in Why. We hope
this document is understandable to most technically-minded readers. Our objective is
to encourage you to get interested in Why and contribute in any way possible.

To achieve this objective, we will introduce the main concepts required for a good
understanding of Why as a Mimblewimble implementation. We will start with a brief
description of some relevant properties of Elliptic Curve Cryptography (ECC) to lay the
foundation on which Why is based and then describe all the key elements of a
...
Deterministic wallets heavily rely on this principle. Mimblewimble and the Why
...
Why, so if you're in a hurry, feel free to jump straight to
