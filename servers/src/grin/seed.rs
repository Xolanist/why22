...
pub const MAINNET_DNS_SEEDS: &[&str] = &[
	"mainnet.seed.why.lesceller.com", // q.lesceller@gmail.com
	"mainnet.seed.why.prokapi.com",   // hendi@prokapi.com
	"whyseed.revcore.net",            // yeastplume@gmail.com
	"mainnet-seed.whynode.live",      // info@whynode.live
	"mainnet.why.punksec.de",         // why@punksec.de
	"whynode.30-r.com",               // trinitron@30-r.com
];
/// DNS Seeds with contact email associated - Testnet
pub const TESTNET_DNS_SEEDS: &[&str] = &[
	"floonet.seed.why.lesceller.com", // q.lesceller@gmail.com
	"floonet.seed.why.prokapi.com",   // hendi@prokapi.com
	"whytestseed.revcore.net",        // yeastplume@gmail.com
	"testnet.why.punksec.de",         // why@punksec.de
	"testnet.whynode.30-r.com",       // trinitron@30-r.com
];
