...
use why_store::Error::NotFoundErr;
...
impl Chain {
	...
	/// Specific tmp dir.
	/// Normally it's ~/.why/main/tmp for mainnet
	/// or ~/.why/test/tmp for Testnet
	...
	pub fn txhashset_write(
		...
		// Write txhashset to sandbox (in the Why specific tmp dir)
