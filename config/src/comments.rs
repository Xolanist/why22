...
fn comments() -> HashMap<String, String> {
	...
	retval.insert(
		...
		"
# Generated Server Configuration File for Why
#
# When running the why executable without specifying any command line
...
"
	...
	retval.insert(
		"db_root".to_string(),
		"
#the directory, relative to current, in which the why blockchain
#is stored
"
		.to_string(),
	);
...
#real mining should use the standalone why-miner
"
		.to_string(),
	);
