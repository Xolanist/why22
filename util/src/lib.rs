...
//! patterns that are frequent within the why codebase.
...
/// Global stopped/paused state shared across various subcomponents of Why.
///
/// "Stopped" allows a clean shutdown of the Why server.
